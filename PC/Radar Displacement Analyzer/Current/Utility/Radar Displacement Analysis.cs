...
namespace Samraksh.AppNote.Utility {
    namespace Radar.DisplacementAnalysis {
        public static class DisplacementAnalysis {
            ...
            public static bool DiagnosticPrint { set; private get; }
            ...
            public static void Analyze(int iValue, int qValue) {
                ...
                if (_lastMofNconfirmation != MofNConfirmation.MofNconfirmation) {
                    ClassParameters.MofNConfirmationCallback(MofNConfirmation.MofNconfirmation, CumulativeCuts.SnippetNum);
                    _lastMofNconfirmation = MofNConfirmation.MofNconfirmation;
                }
