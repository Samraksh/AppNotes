...
namespace Samraksh.Appnote.DotNow.OnOffSwitchSerialLink
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            // Set up an input switch, using the DebouncedSwitch class
            //  This specifies the pin to use, the resistor mode, and a callback method to process switch results
            // ReSharper disable once UnusedVariable
            var onOffSwitch = new DebouncedSwitch(Pins.GPIO_J12_PIN1, Port.ResistorMode.PullUp, SwitchCallback);
        ...
        /// </summary>
        private static class SerialLcd
        {
