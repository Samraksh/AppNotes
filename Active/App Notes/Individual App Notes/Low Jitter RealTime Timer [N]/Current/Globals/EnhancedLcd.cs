 ...
 *  1.2 Migrated to new eMote namespacde
=========================*/
...
namespace Samraksh.AppNote.Utility {
    ...
    public class EnhancedEmoteLcd : EmoteLCD {
        ...
        /// <summary>
        /// Toggle a value in one of the LCD positions
        /// </summary>
        /// <param name="pos"></param>
        /// <param name="value"></param>
        public void Toggle(int pos, char value) {
            _toggleStatus[pos] = !_toggleStatus[pos];
            WriteN(pos, _toggleStatus[pos] ? value.ToLcd() : LCD.CHAR_NULL);
        }
        private readonly bool[] _toggleStatus = { false, false, false, false };
