...
namespace Samraksh.AppNote.Utility {
            ...
            public static class BitConverter {
                ...
                public static void InsertValueIntoArray(byte[] data, int startIndex, bool value) {
                    Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 1, value ? 1u : 0u);
                }
                ...
                public static bool ToBoolean(byte[] value, int startIndex) {
                    return Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 1) != 0u;
                }
                ...
                public static void InsertValueIntoArray(byte[] data, int startIndex, char value) {
                    Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 2, value);
                }
                ...
                public static char ToChar(byte[] value, int startIndex) {
                    return (char)Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 2);
                }
                ...
                public static void InsertValueIntoArray(byte[] data, int startIndex, short value) {
                    Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 2, (uint)value);
                }
                ...
                public static short ToInt16(byte[] value, int startIndex) {
                    return (short)Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 2);
                }
                ...
                public static ushort ToUInt16(byte[] value, int startIndex) {
                    return (ushort)Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 2);
                }
                ...
                public static void InsertValueIntoArray(byte[] data, int startIndex, int value) {
                    Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 4, (uint)value);
                }
                ...
                public static int ToInt32(byte[] value, int startIndex) {
                    return (int)Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 4);
                }
                ...
                public static void InsertValueIntoArray(byte[] data, int startIndex, uint value) {
                    Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 4, value);
                }
                ...
                public static uint ToUInt32(byte[] value, int startIndex) {
                    return Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 4);
                }
                ...
                public static void InsertValueIntoArray(byte[] data, int startIndex, long value) {
                    ...
                    if (IsLittleEndian) {
                        Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 4, low);
                        Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex + 4, 4, high);
                    }
                    else {
                        Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 4, high);
                        Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex + 4, 4, low);
                    }
                }
                ...
                public static long ToInt64(byte[] value, int startIndex) {
                    var value0 = (ulong)Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 4);
                    var value1 = (ulong)Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex + 4, 4);
                ...
                public static void InsertValueIntoArray(byte[] data, int startIndex, float value) {
                    unsafe {
                        ...
                        Microsoft.SPOT.Hardware.Utility.InsertValueIntoArray(data, startIndex, 4, buffer);
                    }
                }
                ...
                public static float ToSingle(byte[] value, int startIndex) {
                    var result = Microsoft.SPOT.Hardware.Utility.ExtractValueFromArray(value, startIndex, 4);
                    unsafe {
                        return *((float*)&result);
                    }
                }
