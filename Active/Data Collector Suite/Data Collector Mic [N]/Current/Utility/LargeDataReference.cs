...
namespace Samraksh.AppNote.Utility {
    ...
    public class LargeDataReference {
        ...
        public ReturnStatus ReadNext(UInt16[] buffer) {
            DataStoreReturnStatus retVal;
