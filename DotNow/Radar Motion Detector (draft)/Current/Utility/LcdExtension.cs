...
namespace Samraksh.AppNote.Utility {
    ...
    /// <summary>
    /// Extend EmoteLCD with initialization and with Display methods for integer and string
    /// </summary>
    public class EmoteLcdUtil : EmoteLCD {
        /// <summary>
        /// Initialize the LCD
        /// </summary>
        public EmoteLcdUtil() {
        ...
        /// <summary>
        /// Display a number. If more then 4 digits, display first 4 only
        /// </summary>
