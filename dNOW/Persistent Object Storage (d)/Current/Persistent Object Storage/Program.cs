...
namespace Samraksh {
    namespace AppNote {
        namespace PersistentObjectStorage {
            ...
            /// <remarks>
            /// There are 2 phases:
            /// 1. Sensing Phase. Erase all DataStore data and sample sensors until five sensors have been sampled. 
            ...
            /// 2. Comparison Phase. Once five sensors have been sampled, stop sampling and read each allocation directly from DataStore.
