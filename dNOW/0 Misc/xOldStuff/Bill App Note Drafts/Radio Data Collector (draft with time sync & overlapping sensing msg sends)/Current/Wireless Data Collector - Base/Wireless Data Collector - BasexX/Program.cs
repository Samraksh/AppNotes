                ...
                try {
                    ...
                    switch (rcvPayloadBytes[2]) {
                        ...
                        case (byte)PayloadTypes.Hello: {
                                ...
                                SensingNodes[rcvMsg.Src] = new InitialTimePair(msgReceivedTime, msgSentTime);
                        ...
                        case (byte)PayloadTypes.Data: {
                                ...
                                while (currPos + PayloadTimeDataPos <= rcvMsg.Size) {
                                    ...
                                    Debug.Print("  Sample time: " + sampleTime + ", adjustment factor: " + adjustmentFactor + ", adjusted sample time:" + adjustedSampleTime + ", sample: " + sampleValue);
